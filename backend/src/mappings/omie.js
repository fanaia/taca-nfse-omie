...
defineOmieMapping("taca-nfse-omie", {
  ...
  calls: {
    ...
    "include-customer": { label: "Incluir cliente", endpoint: "geral/clientes/", call: "IncluirCliente", param: { $path: "$input.param" }, maxAttempts: 1 },
    "update-customer": { label: "Alterar cliente", endpoint: "geral/clientes/", call: "AlterarCliente", param: { $path: "$input.param" }, maxAttempts: 1 },
    "upsert-customer-by-document": { label: "Compatibilidade legado: incluir cliente", endpoint: "geral/clientes/", call: "IncluirCliente", param: { $path: "$input.param" }, maxAttempts: 1 },
