...
const {
  ...
  mapService,
  syncReferenceList,
} = require("../services/taca/referenceData");
...
function inboundList({
  ...
  return {
    ...
    policies: {
      create: true,
      update: true,
      inactivate: Boolean(activeField),
...
defineOmieMapping("taca-nfse-omie", {
  ...
  calls: {
    ...
    "list-services": {
      ...
      param: [{ nPagina: "$input.page", nRegPorPagina: "$input.pageSize" }],
      maxAttempts: 1,
      pagination: { itemsPath: "cadastros", totalPagesPath: "nTotPaginas", pageSize: 100 },
    },
    "list-categories": {
      ...
      maxAttempts: 1,
      pagination: { itemsPath: "categoria_cadastro", totalPagesPath: "total_de_paginas", pageSize: 100 },
    },
    "list-current-accounts": {
      label: "Listar contas correntes",
      endpoint: "geral/contacorrente/",
      call: "ListarContasCorrentes",
      param: [{ pagina: "$input.page", registros_por_pagina: "$input.pageSize", apenas_importado_api: "N" }],
      maxAttempts: 1,
      pagination: { itemsPath: "ListarContasCorrentes", totalPagesPath: "total_de_paginas", pageSize: 100 },
    },
    "list-payment-terms": {
      label: "Listar condições de pagamento",
      endpoint: "produtos/formaspagvendas/",
      call: "ListarFormasPagVendas",
      param: [{ pagina: "$input.page", registros_por_pagina: "$input.pageSize" }],
      maxAttempts: 1,
      pagination: { itemsPath: "cadastros", totalPagesPath: "total_de_paginas", pageSize: 100 },
    },
    "list-cities": {
      label: "Listar cidades",
      endpoint: "geral/cidades/",
      call: "PesquisarCidades",
      param: [{ pagina: "$input.page", registros_por_pagina: "$input.pageSize" }],
      maxAttempts: 1,
      pagination: { itemsPath: "lista_cidades", totalPagesPath: "total_de_paginas", pageSize: 100 },
    },
  ...
  lists: [
    inboundList({
      key: "services",
      label: "Serviços",
      description: "Serviços prestados cadastrados no Omie para seleção na emissão de NFS-e.",
      call: "list-services",
      model: "ServicoOmie",
    ...
    inboundList({
      key: "categories",
      label: "Categorias",
      description: "Categorias financeiras do Omie usadas na Ordem de Serviço.",
    ...
    inboundList({
      ...
      description: "Contas correntes disponíveis para a Ordem de Serviço.",
      call: "list-current-accounts",
      model: "ContaCorrenteOmie",
      externalKey: "codigoContaCorrenteOmie",
      mapping: mapCurrentAccount,
      activeField: "status",
      order: 30,
    }),
    inboundList({
      ...
      description: "Formas/condições de pagamento de vendas aceitas em cCodParc.",
      call: "list-payment-terms",
      model: "CondicaoPagamentoOmie",
      externalKey: "codigoCondicaoPagamento",
      mapping: mapPaymentTerm,
      order: 40,
    }),
    inboundList({
      key: "cities",
      label: "Cidades",
      description: "Cidades do Omie usadas em cCidPrestServ.",
      call: "list-cities",
      model: "CidadeOmie",
